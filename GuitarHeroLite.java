...
public class GuitarHeroLite {
    ...
    public static void main(String[] args) {
        ...
        GuitarString stringC = new GuitarString(CONCERT_C);
            stringA.buffer.printVerboseInfo();
            stringC.buffer.printVerboseInfo();
        ...
        while (true) {
            ...
            if (StdDraw.hasNextKeyTyped()) {
                ...
                if (key == 'a') { stringA.pluck(); stringA.buffer.printVerboseInfo(); }
                if (key == 'c') { stringC.pluck(); stringC.buffer.printVerboseInfo(); }
            }
